...
import 'package:LMS_application/Screens/Student/Discussion/model.dart';
import 'package:LMS_application/Screens/Student/Discussion/utils.dart';

void main() => runApp(TeacherDiscussionForm());

class TeacherDiscussionForm extends StatelessWidget {
  @override
...
class MyHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Teacher Discussion Form"),
